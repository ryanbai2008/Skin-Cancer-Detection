...
if (currentExample == 1) {
  ...
  exampleResult.innerHTML = `<p><strong>Example of Benign Keratosis-Like Lesion classification</strong></p>`;
}
else if (currentExample == 3) {
  exampleResult.innerHTML = `<p><strong>Example of Dermatofibroma classification</strong></p>`;
}
...
exampleButtons.forEach(btn => {
  btn.addEventListener("click", () => {
    ...
    //update image
    exampleImage.src = `assets/new_example_image_${exampleNum}.jpg`;
